...
#define OS_LWR      OSL(LOWER)                  // One shot lower
#define OS_RSE      OSL(RAISE)                  // One shot lower
...
[_COLEMAK] = LAYOUT_planck_grid(
    HPR_TAB,  UK_Q,    UK_W,    UK_F,    UK_P,    UK_G,    UK_J,    UK_L,    UK_U,    UK_Y,    UK_SCLN, KC_BSPC,
    CTL_ESC,  UK_A,    UK_R,    UK_S,    UK_T,    UK_D,    UK_H,    UK_N,    UK_E,    UK_I,    UK_O,    CTL_ENT,
    OS_LSFT,  UK_Z,    UK_X,    UK_C,    UK_V,    UK_B,    UK_K,    UK_M,    UK_COMM, UK_DOT,  UK_SLSH, OS_RSFT,
    MEH_GRV,  KC_LCTL, KC_LALT, KC_LGUI, OS_LWR,  KC_SPC,  KC_SPC,  OS_RSE,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
